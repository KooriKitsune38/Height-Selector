...
execute if score @s height matches ..-1 run tellraw @s [{"text":"","underlined": true,"clickEvent": {"action": "suggest_command","value": "/trigger height set 0"},"hoverEvent": {"action": "show_text","contents": "Click to paste the command in chat."}},{"text":"| ","color":"gray","underlined": false},{"text":"Usage: ","color":"#ef7a85","underlined": false},{"text":"/trigger height set ","color":"#f2929a"},{"text":"centimetres","color":"white"}]
